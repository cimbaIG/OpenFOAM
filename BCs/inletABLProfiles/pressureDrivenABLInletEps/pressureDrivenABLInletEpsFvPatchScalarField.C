...
#include "pressureDrivenABLInletEpsFvPatchScalarField.H"
...
pressureDrivenABLInletEpsFvPatchScalarField::pressureDrivenABLInletEpsFvPatchScalarField
(
    const fvPatch& p,
...
pressureDrivenABLInletEpsFvPatchScalarField::pressureDrivenABLInletEpsFvPatchScalarField
(
    const pressureDrivenABLInletEpsFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    z_(dict.lookup("z"))
{
    if (mag(z_) < SMALL)
    {
        FatalErrorIn("pressureDrivenABLInletEpsFvPatchScalarField(dict)")
...
pressureDrivenABLInletEpsFvPatchScalarField::pressureDrivenABLInletEpsFvPatchScalarField
(
    const pressureDrivenABLInletEpsFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void pressureDrivenABLInletEpsFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    forAll(coord, i)
    {
	  ...
	  + Ck4_ * Foam::pow(zRef,6) );
		...
		Eps[i] = ((Cmu_ * sqr(Tke[i])) / (kappa_ * uTau_ * coord[i])) * 
...
// Write
void pressureDrivenABLInletEpsFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, pressureDrivenABLInletEpsFvPatchScalarField);
